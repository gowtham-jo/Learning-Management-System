...
const Homepage = () => {
  ...
  return (
    <div className="home-container">
      ...
      <div className="card" style={{ width: "18rem",border:"3px solid white" }}>
        <img src={mern} className="card-img-top" alt="..."style={{width:""}} />
          <div className="card-body" style={{ borderRadius: "10px" ,border:"1px white solid"}}>
